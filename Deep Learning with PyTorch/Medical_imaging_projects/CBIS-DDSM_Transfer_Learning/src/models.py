...
class CBISDDSMFinalClassifier(pl.LightningModule):
    def __init__(self, parameters):
        super(CBISDDSMFinalClassifier, self).__init__()
        self.patch_model_name = parameters['patch_model_name']
        self.patch_model_path = parameters['patch_model_path']
        self.batch_size = parameters['batch_size']
        self.resizing_factor = parameters['resizing_factor']
        self.data_folder = parameters['data_folder']
        self.num_classes = parameters['num_classes']
